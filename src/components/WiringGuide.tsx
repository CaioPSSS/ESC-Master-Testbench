      ...
      >
        <div>
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
            Guia de Conexão Física e Segurança (LoRa)
            {isExpanded ? <ChevronUp className="w-4 h-4 text-slate-500" /> : <ChevronDown className="w-4 h-4 text-slate-500" />}
          </h3>
          <p className="text-[10px] text-slate-500 mt-1">Especificações de hardware, pinagem SPI dos módulos LoRa e diagrama de fios.</p>
        </div>
      </div>
          ...
          <div>
            <div className="grid grid-cols-2 gap-px bg-slate-800 border border-slate-800 rounded-lg overflow-hidden">
              ...
              <div className="bg-slate-900 p-3 flex justify-between">
                ...
                <span className="text-xs text-amber-400">LoRa Wireless</span>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="bg-slate-900 border border-slate-800 rounded-lg p-4 space-y-4">
              <div className="flex flex-col">
                <span className="text-[10px] font-bold text-amber-500 uppercase">1. ESP32 Bridge (Lado do Notebook)</span>
                <span className="text-xs text-slate-400 mt-1">Conecte o ESP32 ao PC via cabo USB. O módulo LoRa SX1278 é ligado ao ESP32 via SPI (veja a tabela de pinagem acima). O ESP32 atua apenas como ponte: recebe comandos do Dashboard via Serial USB e os retransmite via LoRa. Recebe telemetria LoRa e a imprime na Serial.</span>
              </div>
              <div className="flex flex-col border-t border-slate-800 pt-4 mt-2">
                <span className="text-[10px] font-bold text-emerald-500 uppercase">2. Arduino Remoto (Lado do Motor)</span>
                <span className="text-xs text-slate-400 mt-1">Conecte o módulo LoRa SX1278 ao Arduino Uno via SPI (veja a tabela acima). O fio de sinal PWM do ESC (Amarelo) vai no <strong>Pino 6</strong> (o Pino 9 é usado pelo LoRa NRESET). GND do Arduino deve ser comum ao GND do ESC (fio marrom/preto). Se o Arduino for alimentado pela bateria (via regulador), o BEC do ESC pode ser desconectado.</span>
              </div>
              <div className="flex flex-col border-t border-slate-800 pt-4 mt-2">
                <span className="text-[10px] font-bold text-rose-500 uppercase">3. Atenção: Alimentação do LoRa</span>
              ...
              <div className="flex flex-col border-t border-slate-800 pt-4 mt-2">
                <span className="text-[10px] font-bold text-amber-500 uppercase">4. Bateria 2S 18650 (Série)</span>
              ...
              <div className="flex flex-col border-t border-slate-800 pt-4 mt-2">
                <span className="text-[10px] font-bold text-rose-500 uppercase">5. Precauções de Teste</span>
              ...
              <div className="flex flex-col border-t border-slate-800 pt-4 mt-2">
                <span className="text-[10px] font-bold text-cyan-400 uppercase">6. Como Inverter a Rotação? (Fios vs Código)</span>
              ...
              <div className="flex flex-col border-t border-slate-800 pt-4 mt-2">
                <span className="text-[10px] font-bold text-amber-500 uppercase">7. A velocidade não aumenta depois de uma certa %? (Calibração)</span>
              ...
              <div className="flex flex-col border-t border-slate-800 pt-4 mt-2">
                <span className="text-[10px] font-bold text-emerald-500 uppercase">8. Leitura de Voltagem e Proteção (Telemetria)</span>
